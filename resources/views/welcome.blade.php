                        ...
                        <div class="bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden mb-6">
                            ...
                            <div class=" p-6 border-b border-gray-200"  style="background-color:rgb(230, 253, 212);">
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div class="flex-1">
                                        <h2 class="text-lg lg:text-lg font-bold text-green-800 mb-2 mt-2">
                            ...
                            <div class="p-6 space-y-6">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 ml-11">
                                        <div class="bg-green-50 p-4 rounded-lg">
                                            <div class="flex items-start space-x-3">
                                                ...
                                                <div>
                                                    <h4 class="text-md font-semibold text-green-800 mb-2">Palakasin ang
                                                        Kakayahan</h4>
                                ...
                                <div class="border-l-4 border-green-400 pl-2 sm:pl-4">
                                    <div class="flex items-start space-x-2 sm:space-x-3 mb-4 sm:mb-6">
                                        ...
                                        <h3 class="text-sm sm:text-md font-bold text-gray-800 mt-1 leading-tight">Mga Kasama sa Programa</h3>
                                    </div>

                                    <div class="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 sm:gap-3 ml-8 sm:ml-10 lg:ml-11">
                                        <div class="bg-gray-50 p-2 sm:p-3 rounded-lg text-center hover:shadow-md transition-shadow duration-200">
                                            <div
                                            ...
                                            <span class="text-xs sm:text-sm font-semibold text-gray-700 leading-tight block">Training</span>
                                        </div>
                                        ...
                                        <div class="bg-gray-50 p-2 sm:p-3 rounded-lg text-center hover:shadow-md transition-shadow duration-200">
                                            ...
                                            <span class="text-xs sm:text-sm font-semibold text-gray-700 leading-tight block">Demonstration<br class="hidden xs:block">
                                                Services</span>
                                        </div>
                                        ...
                                        <div class="bg-gray-50 p-2 sm:p-3 rounded-lg text-center hover:shadow-md transition-shadow duration-200">
                                            ...
                                            <span class="text-xs sm:text-sm font-semibold text-gray-700 leading-tight block">Information<br class="hidden xs:block"> Support</span>
                                        </div>
                                        ...
                                        <div class="bg-gray-50 p-2 sm:p-3 rounded-lg text-center hover:shadow-md transition-shadow duration-200">
                                            ...
                                            <span class="text-xs sm:text-sm font-semibold text-gray-700 leading-tight block">Technical<br class="hidden xs:block">
                                                Assistance</span>
                                        </div>

                                        <div class="bg-gray-50 p-2 sm:p-3 rounded-lg text-center hover:shadow-md transition-shadow duration-200 xs:col-span-2 sm:col-span-1">
                                            <div
                                            ...
                                            <span class="text-xs sm:text-sm font-semibold text-gray-700 leading-tight block">Complementary<br class="hidden xs:block">
                                                Projects</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden mb-6">
                            ...
                            <div class="bg-yellow-50 p-6 border-b border-gray-200">
                                <div class="flex items-center space-x-3 mb-2">
                                    ...
                                    <div class="flex-1">
                                        <h2 class="text-lg font-bold text-yellow-800 mt-2">Mga Kriterya para sa Pagpili</h2>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 ml-14">
                                        <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                                            <div class="flex items-start space-x-3">
                                                ...
                                                <div class="flex-1">
                                                    <h4 class="font-semibold text-sm text-gray-800 mb-2 mt-1">Integrated Farm</h4>
                                        ...
                                        <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                                            <div class="flex items-start space-x-3">
                                                ...
                                                <div class="flex-1">
                                                    <h4 class="font-semibold text-sm text-gray-800 mb-2 mt-1">Coconut Farmland</h4>
                                        ...
                                        <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                                            <div class="flex items-start space-x-3">
                                                ...
                                                <div class="flex-1">
                                                    <h4 class="font-semibold text-sm text-gray-800 mb-2 mt-1">Valid Registration</h4>
                                        ...
                                        <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                                            <div class="flex items-start space-x-3">
                                                ...
                                                <div class="flex-1">
                                                    <h4 class="font-semibold text-sm text-gray-800 mb-2 mt-1">Active Organization
                                                    </h4>
                                        ...
                                        <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                                            <div class="flex items-start space-x-3">
                                                ...
                                                <div class="flex-1">
                                                    <h4 class="font-semibold text-sm text-gray-800 mb-2 mt-1">Filipino Leaders</h4>
                                        ...
                                        <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                                            <div class="flex items-start space-x-3">
                                                ...
                                                <div class="flex-1">
                                                    <h4 class="font-semibold text-sm text-gray-800 mb-2 mt-1">Training Ready</h4>
                                        ...
                                        <div class="bg-green-50 border border-green-200 rounded-lg p-4 md:col-span-2">
                                            <div class="flex items-start space-x-3">
                                                ...
                                                <div class="flex-1">
                                                    <h4 class="font-semibold text-sm text-gray-800 mb-2 mt-1">Physically Capable</h4>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 ml-14">
                                        ...
                                        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                                            <div class="flex items-start space-x-3">
                                                ...
                                                <div class="flex-1">
                                                    <h4 class="font-semibold text-sm text-gray-800 mb-2 mt-1">Demo Area</h4>
                                                    <p class="text-gray-600 text-sm">May technology demonstration area
                                        ...
                                        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                                            <div class="flex items-start space-x-3">
                                                ...
                                                <div class="flex-1">
                                                    <h4 class="font-semibold text-sm text-gray-800 mb-2 mt-1">Accessible Location
                                                    </h4>
                                                    <p class="text-gray-600 text-sm">Madaling puntahan thru land at iba
                                        ...
                                        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                                            <div class="flex items-start space-x-3">
                                                ...
                                                <div class="flex-1">
                                                    <h4 class="font-semibold text-sm text-gray-800 mb-2 mt-1">Well-Landscaped</h4>
                                                    <p class="text-gray-600 text-sm">Maganda at organisadong farm layout
